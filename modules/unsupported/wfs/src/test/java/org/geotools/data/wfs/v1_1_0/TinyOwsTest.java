...
public class TinyOwsTest {
    ...
    public void testGetFirstFeatures() throws Exception {        
        ...
        iterate(source.getFeatures(query), 20);        
    }
    
    @Test
    public void testGetFeatureById() throws Exception {        
        WFSDataStore wfs = getWFSDataStore(new LoggingHTTPClient(new TinyOwsMockHttpClient()));
        ...
        iterate(source.getFeatures(query), 1);
    }    
    ...
    public void testGetFeaturesByBBox() throws Exception {
        ...
        iterate(source.getFeatures(query), 6);        
    }
    ...
    private static SimpleFeature iterate(SimpleFeatureCollection features, int expectedSize) {
        if (features.size() > -1) {
            Assert.assertEquals(expectedSize, features.size());
        }
